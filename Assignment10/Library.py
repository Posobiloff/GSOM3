class Book:
    ...
    def __init__(self, title, author, year, price, stoplist, genre):
        ...
        self.genre = genre
    def get_info(self):
        return (f"We know that about this book: it is by {self.author}, it is called {self.title}, it was firstly published in {self.year}, it costs {self.price}, and it is in stoplist: {self.stoplist}")
